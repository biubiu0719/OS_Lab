...
LoadUsrProg1:
    mov ax,cs                  ; 段地址 ; 存放数据的内存基地址
    mov es,ax                  ; 设置段地址（不能直接mov es,段地址）
    mov bx, offset_program1    ; 偏移地址; 存放数据的内存偏移地址
    mov ah,2                   ; 功能号
    mov al,2                   ; 扇区数
    mov dl,0                   ; 驱动器号 ; 软盘为0，硬盘和U盘为80H
    mov dh,0                   ; 磁头号 ; 起始编号为0
...
LoadUsrProg2:
    mov ax,cs                  ; 段地址 ; 存放数据的内存基地址
    mov es,ax                  ; 设置段地址（不能直接mov es,段地址）
    mov bx, offset_program2    ; 偏移地址; 存放数据的内存偏移地址
    mov ah,2                   ; 功能号
    mov al,2                   ; 扇区数
    mov dl,0                   ; 驱动器号 ; 软盘为0，硬盘和U盘为80H
    mov dh,0                   ; 磁头号 ; 起始编号为0
...
LoadUsrProg3:
    mov ax,cs                  ; 段地址 ; 存放数据的内存基地址
    mov es,ax                  ; 设置段地址（不能直接mov es,段地址）
    mov bx, offset_program3    ; 偏移地址; 存放数据的内存偏移地址
    mov ah,2                   ; 功能号
    mov al,2                   ; 扇区数
    mov dl,0                   ; 驱动器号 ; 软盘为0，硬盘和U盘为80H
    mov dh,0                   ; 磁头号 ; 起始编号为0
...
LoadUsrProg4:
    mov ax,cs                  ; 段地址 ; 存放数据的内存基地址
    mov es,ax                  ; 设置段地址（不能直接mov es,段地址）
    mov bx, offset_program4    ; 偏移地址; 存放数据的内存偏移地址
    mov ah,2                   ; 功能号
    mov al,2                   ; 扇区数
    mov dl,0                   ; 驱动器号 ; 软盘为0，硬盘和U盘为80H
    mov dh,0                   ; 磁头号 ; 起始编号为0
