...
dd if=./temp/booter.bin of=myosv5.img bs=512 count=1 2>/dev/null
dd if=./temp/kernel.bin of=myosv5.img bs=512 seek=1 count=35 2>/dev/null
dd if=./temp/topleft.com of=myosv5.img bs=512 seek=36 count=2 2>/dev/null
dd if=./temp/topright.bin of=myosv5.img bs=512 seek=38 count=2 2>/dev/null
dd if=./temp/bottomleft.bin of=myosv5.img bs=512 seek=40 count=2 2>/dev/null
dd if=./temp/bottomright.bin of=myosv5.img bs=512 seek=42 count=2 2>/dev/null
dd if=./temp/list.bin of=myosv5.img bs=512 seek=44 count=2 2>/dev/null
dd if=./temp/main.bin of=myosv5.img bs=512 seek=46 count=24 2>/dev/null
dd if=./temp/sys_test.bin of=myosv5.img bs=512 seek=70 count=2 2>/dev/null
echo "[+] Done."
