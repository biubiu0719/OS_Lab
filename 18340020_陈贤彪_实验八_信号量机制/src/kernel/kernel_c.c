...
//初始化用户3
    ...
    user[6].id=7;
    user[6].name="fork_test";
    user[6].size=2;
    user[6].cylinder=1;
    user[6].head=1;
    user[6].sector=13;
    user[6].offset=0x7000;
    ...
    user[7].head=1;
    user[7].sector=15;
    user[7].offset=0x8000;

    user[8].id=8;
    user[8].name="pv_test2";
    user[8].size=2;
    user[8].cylinder=1;
    user[8].head=1;
    user[8].sector=17;
    user[8].offset=0x9000;
}
void startos() {
    clearScreen();
    char* title = "MYOS v8";
    ...
    while(1)
    {
           ...
           // print(ll);
        ...
        else if(strcmp(first,commands[6])==0)//runall
            {
                ...
                int flag=1;
                int flag124[10];
                for(int i=0;i<10;i++)flag124[i]=0;
                for(int i=0;i<backlen;i++)
                {
                    ...
                    for(int i=0;i<backlen;i++)
                     {
                         ...
                         else if(back[i]=='9'&&flag124[8]==0)
                         {
                             flag124[8]=1;
                                loadm(user[7].size,user[7].head,user[7].cylinder,user[7].sector,user[7].offset);
                             pcb_table[8].zhuangtai=1;
                            pcb_table[8].reg.cs=user[7].offset;
                            pcb_table[8].reg.ds=user[7].offset;
                            pcb_table[8].reg.es=user[7].offset;
                            pcb_table[8].reg.fs=user[7].offset;
                            pcb_table[8].reg.ss=user[7].offset;
                         }
                         else if(back[i]=='8'&&flag124[9]==0)
                         {
                             flag124[9]=1;
                                loadm(user[8].size,user[8].head,user[8].cylinder,user[8].sector,user[8].offset);
                             pcb_table[9].zhuangtai=1;
                            pcb_table[9].reg.cs=user[8].offset;
                            pcb_table[9].reg.ds=user[8].offset;
                            pcb_table[9].reg.es=user[8].offset;
                            pcb_table[9].reg.fs=user[8].offset;
                            pcb_table[9].reg.ss=user[8].offset;
                         }
